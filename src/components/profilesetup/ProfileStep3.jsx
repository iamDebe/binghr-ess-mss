...
const ProfileSetup = () => {
  ...
  const formik = useFormik ({
    ...
    onSubmit: () => {
      ...
      formdata.append("suffix", formik.title);
      formdata.append("firstname", formdata.firstName);
      formdata.append("lastname", formik.lastName);
      formdata.append("middlename", formik.middleName);
      formdata.append("prefered_firstname", formik.preferredFirstName);
      formdata.append("prefered_lastname", formik.preferredLastName);
