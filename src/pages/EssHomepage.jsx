        ...
        <EssLayout>
            <Inner>
                <WelcomeSection>
                    ...
                    <p className="type-body2">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque ut malesuada massa. Sed sodales arcu in eleifend aliquam. Nam id ex viverra, mattis turpis sed, ullamcorper metus. Integer fermentum, sapien sed fringilla condimentum, diam dui ultricies risus.</p>
                </WelcomeSection>
                <MenuCardRow>
                    <MenuCard link="#" icon={<ProfileHomeIcon fill="#858585" />} title="My Profile" />
                    <MenuCard link="#" icon={<MyPayIcon fill="#858585" />} title="My Pay" />
                    <MenuCard link="#" icon={<ClockIcon fill="#858585" />} title="My Time Off" />
                    <MenuCard link="#" icon={<CalendarIcon fill="#858585" />} title="Timesheet" />
                    <MenuCard link="#" icon={<ChartIcon fill="#858585" />} title="Org Chart" />
                </MenuCardRow>
                <EmployeeSummaryRow>
                    <EmployeeInfo>
